...
const indicatorInfo = {
  ekonomi: {
    ...
    insight: (rn) =>
      `Pertumbuhan ekonomi di ${rn} meningkat signifikan pada tahun 2025 yaitu sebesar 15,54%.`,
  },
  tpt: {
    def: "Persentase jumlah pengangguran terhadap jumlah angkatan kerja",
    img: "assets/img/TPT.jpg",
    insight: (rn) =>
      `TPT menunjukkan tren menurun dari 2021 hingga 2025, mencerminkan perbaikan kondisi ketenagakerjaan di ${rn}.`,
  },
  pdrb: {
    def: "Nilai PDRB dibagi jumlah penduduk dalam suatu wilayah pada periode tertentu",
    img: "assets/img/PDRB perkapita.jpg",
    insight: (rn) => `PDRB per kapita ${rn} meningkat dari tahun ke tahun.`,
  },
  ipm: {
  ...
  gini: {
    ...
    insight: (rn) => `Gini Ratio Anambas pada Maret 2025 sebesar 0,309.`,
  },
  inflasi: {
    def: "-",
    img: "assets/img/inflasi.jpeg",
    insight: (rn) => `Data inflasi tidak tersedia`,
  },
  penduduk: {
    def: "Total orang yang tinggal dan menetap di suatu wilayah pada waktu tertentu.",
    img: "assets/img/penduduk.jpeg",
    insight: (rn) =>
      `Jumlah penduduk di ${rn} bertambah secara proporsional berdasar sensus terbaru.`,
  },
  wisman: {
    def: "-",
