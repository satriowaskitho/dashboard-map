...
const indicatorInfo = {
  ekonomi: {
    ...
    insight: (rn) =>
      `Pertumbuhan ekonomi di ${rn} meningkat pada tahun 2025 sebesar 3,53%.`,
  },
  tpt: {
    def: "Persentase jumlah pengangguran terhadap jumlah angkatan kerja",
    img: "assets/img/TPT.jpg",
    insight: (rn) => `TPT fluktuatif dari 2022 hingga 2025 di ${rn}.`,
  },
  pdrb: {
  ...
  aps: {
    ...
    insight: (rn) =>
      `Angka partisipasi sekolah (APS) SMA/SMK (16-18 tahun) pada tahun 2025 di ${rn} sebesar 90,84%.`,
  },
  ipg: {
  ...
  gini: {
    ...
    insight: (rn) => `Gini ratio di ${rn} pada Maret 2025 sebesar 0,286.`,
  },
  inflasi: {
    def: "-",
  ...
  penduduk: {
    ...
    insight: (rn) =>
      `Jumlah penduduk di ${rn} pada tahun 2020 sebesar 98.633 jiwa.`,
  },
  wisman: {
    def: "-",
...
function openModal(type, regionKey = "lingga", regionName = "Kepulauan Riau") {
