...
const indicatorInfo = {
  ekonomi: {
    ...
    insight: (rn) =>
      `Pertumbuhan ekonomi di ${rn} pada tahun 2025 sebesar 3,31%.`,
  },
  tpt: {
    def: "Persentase jumlah pengangguran terhadap jumlah angkatan kerja",
    img: "assets/img/TPT.jpg",
    insight: (rn) =>
      `TPT menunjukkan tren menurun dari 2021 hingga 2024, dan naik kembali pada 2025 di ${rn}.`,
  },
  pdrb: {
  ...
  aps: {
    ...
    insight: (rn) =>
      `Angka partisipasi sekolah (APS) SMA/SMK (16-18 tahun) pada tahun 2025 di ${rn} sebesar 94,51%.`,
  },
  ipg: {
    def: "Indikator yang mengukur kesetaraan capaian pembangunan manusia antara laki-laki dan perempuan.",
    img: "assets/img/IPG.jpeg",
    insight: (rn) =>
      `IPG di ${rn} menunjukkan tren fluktatif dari tahun ke tahun.`,
  },
  kemiskinan: {
  ...
  gini: {
    ...
    insight: (rn) => `Gini ratio di ${rn} pada Maret 2025 sebesar 0,318.`,
  },
  inflasi: {
