...
const indicatorInfo = {
  ekonomi: {
    ...
    insight: (rn) =>
      `Pertumbuhan ekonomi di ${rn} pada tahun 2025 sebesar 5,44%.`,
  },
  tpt: {
    def: "Persentase jumlah pengangguran terhadap jumlah angkatan kerja",
    img: "assets/img/TPT.jpg",
    insight: (rn) =>
      `TPT menunjukkan tren menurun dari 2020 hingga 2024 dan naik kembali pada 2025.`,
  },
  pdrb: {
  ...
  aps: {
    ...
    insight: (rn) =>
      `Angka partisipasi sekolah (APS) SMA/SMK (16-18 tahun) pada tahun 2025 di ${rn} sebesar 83,21%.`,
  },
  ipg: {
    def: "Indikator yang mengukur kesetaraan capaian pembangunan manusia antara laki-laki dan perempuan.",
    img: "assets/img/IPG.jpeg",
    insight: (rn) =>
      `IPG di ${rn} menunjukkan tren meningkat dari tahun 2021 hingga 2024 yang menunjukkan kesetaraan capaian pembangunan antara laki-laki dan perempuan semakin membaik`,
  },
  kemiskinan: {
  ...
  gini: {
    ...
    insight: (rn) => `Gini ratio di ${rn} pada Maret 2025 sebesar 0,331.`,
  },
  inflasi: {
    ...
    insight: (rn) => `Inflasi Februari 2026 di ${rn} sebesar 4,13%.`,
  },
  penduduk: {
    def: "Total orang yang tinggal dan menetap di suatu wilayah pada waktu tertentu.",
    img: "assets/img/penduduk.jpeg",
    insight: (rn) =>
      `Jumlah penduduk di ${rn} pada tahun 2020 sebesar 253.457 jiwa.`,
  },
  wisman: {
  ...
  ekspor: {
    ...
    insight: (rn) =>
      `Aktivitas ekspor ${rn} menunjukkan tren pertumbuhan yang solid.`,
  },
  impor: {
    def: "-",
    img: "assets/img/impor.jpeg",
    insight: (rn) =>
      `Nilai impor di ${rn} meningkat sejalan dengan kebutuhan suplai industri.`,
  },
};
