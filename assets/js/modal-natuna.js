...
const indicatorInfo = {
  ekonomi: {
    ...
    insight: (rn) =>
      `Pertumbuhan ekonomi di ${rn} meningkat signifikan pada tahun 2025 yaitu sebesar 10,49%.`,
  },
  tpt: {
    def: "Persentase jumlah pengangguran terhadap jumlah angkatan kerja",
    img: "assets/img/TPT.jpg",
    insight: (rn) =>
      `TPT menunjukkan tren menurun dari 2022 hingga 2024, dan naik kembali pada 2025 di ${rn}.`,
  },
  pdrb: {
    def: "Nilai PDRB dibagi jumlah penduduk dalam suatu wilayah pada periode tertentu",
    img: "assets/img/PDRB perkapita.jpg",
    insight: (rn) => `PDRB per kapita ${rn} fluktuatif dari tahun ke tahun.`,
  },
  ipm: {
  ...
  aps: {
    ...
    insight: (rn) =>
      `Angka partisipasi sekolah (APS) SMA/SMK (16-18 tahun) pada tahun 2025 di ${rn} sebesar 86,04%.`,
  },
  ipg: {
  ...
  gini: {
    ...
    insight: (rn) => `Gini ratio di ${rn} pada Maret 2025 sebesar 0,263.`,
  },
  inflasi: {
    def: "-",
  ...
  penduduk: {
    ...
    insight: (rn) =>
      `Jumlah penduduk di ${rn} pada tahun 2020 sebesar 81.495 jiwa.`,
  },
  wisman: {
    def: "-",
