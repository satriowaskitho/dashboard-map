...
const indicatorInfo = {
  ekonomi: {
    ...
    insight: (rn) =>
      `Pertumbuhan ekonomi di ${rn} pada tahun 2025 sebesar 6,76%`,
  },
  tpt: {
    def: "Persentase jumlah pengangguran terhadap jumlah angkatan kerja",
    img: "assets/img/TPT.jpg",
    insight: (rn) =>
      `TPT menunjukkan tren menurun dari 2020 hingga 2025, mencerminkan perbaikan kondisi ketenagakerjaan di ${rn}.`,
  },
  pdrb: {
  ...
  aps: {
    ...
    insight: (rn) =>
      `Angka partisipasi sekolah (APS) SMA/SMK (16-18 tahun) pada tahun 2025 di ${rn} sebesar 87,80%.`,
  },
  ipg: {
  ...
  gini: {
    ...
    insight: (rn) => `Gini ratio di ${rn} pada Maret 2025 sebesar 0,386.`,
  },
  inflasi: {
  ...
  penduduk: {
    ...
    insight: (rn) =>
      `Jumlah penduduk di ${rn} pada tahun 2020 sebesar 1.196.396 jiwa.`,
  },
  wisman: {
